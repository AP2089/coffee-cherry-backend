...
router.post('/uploads', requireAuth, uploadImageMiddleware, uploadController.uploadImage)
router.get('/coffees', controller.getCoffees)
router.post('/coffees', requireAuth, controller.createCoffee)
router.get('/coffees/:slug', controller.getCoffeeBySlug)
router.patch('/coffees/:slug', requireAuth, controller.updateCoffee)
router.delete('/coffees/:slug/image', requireAuth, controller.deleteCoffeeImage)
router.delete('/coffees/:slug', requireAuth, controller.deleteCoffee)

router.post('/orders', controller.createOrder)
router.get('/orders', requireAuth, controller.listOrders)
router.get('/orders/:id', requireAuth, controller.getOrderById)
router.patch('/orders/:id', requireAuth, controller.updateOrder)
...
router.patch('/contacts/:id', requireAuth, controller.updateContactMessage)
